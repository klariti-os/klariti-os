...
ALTER TABLE "user_preferences" ADD CONSTRAINT "user_preferences_default_profile_id_profiles_id_fk" FOREIGN KEY ("default_profile_id") REFERENCES "public"."profiles"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
