...
import challengesRoutes from "./routes/me/challenges";
import friendsRoutes from "./routes/me/friends";
...
fastify.register(challengesRoutes, { prefix: "/api/me/challenges" });
fastify.register(friendsRoutes, { prefix: "/api/me/friends" });
